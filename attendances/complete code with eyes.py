...
def verify_admin():
    ...
    if entered_password == key:
        admin_window.destroy()
        open_main_window()
    else:
        messagebox.showerror("Error", "Incorrect password")
def check_haarcascadefile():
    exists = os.path.isfile(r"C:\Users\rkssp\Desktop\virtual envi\attendances_venv\pythonProject1\New folder\haarcascade_frontalface_default.xml")
    if not exists:
...
def TakeImages():
    ...
    assure_path_exists("EyeImages/")  # New folder for saving eye images
    ...
    # Continue with capturing images
    harcascadePath = r"C:\Users\rkssp\Desktop\virtual envi\attendances_venv\pythonProject1\New folder\haarcascade_frontalface_default.xml"
...
def TrackImages():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            for (ex, ey, ew, eh) in eyes:
                ...
                # You can add further processing for eye detection here
            ...
            if conf < 50:
                ...
                speak_text = f"Attendance recorded for {bb}"
    ...
    with open("Attendance\Attendance_" + date + ".csv", 'r') as csvFile1:
        ...
        for lines in reader1:
            i = i + 1
            if i > 1 and len(lines) >= 7:  # Check if the line has enough elements
                if i % 2 != 0:
                    iidd = str(lines[0]) + '   '
...
image_path = r"C:\Users\rkssp\Documents\Presentation1.jpg"
try:
...
# Create a Label widget for the watermark
...
# Function to update the position of the watermark
...
########################################################################################################################
image_path1 = r"C:\Users\rkssp\Downloads\images.jpg"
try:
...
window.bind('<Configure>', update_watermark_position)
text_label = tk.Label(window, text="DEPT. OF ECE", font=('Times New Roman', 18, 'bold'),bg = "#ffdc94")
text_label.place(relx=0.43, rely=0.8)
############################################################################################################################
frame2 = tk.Frame(window, bg="#00FFFF")
frame2.place(relx=0.6, rely=0.17, relwidth=0.39, relheight=0.80)
#################################################################################################################################

image_path2 = r"C:\Users\rkssp\Downloads\waterfall-clean-tourist-blue-flow-asian_1417-1350.jpg"
try:
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System", fg="white", bg="#FFA500",
...
head2 = tk.Label(frame2, text="                 New Registrations                        ", fg="black", bg="#2E8B57",
                 font=('Georgia', 20, 'bold'))
head2.grid(row=0, column=0)

head1 = tk.Label(frame1, text="                            Registered                                      ",
                 fg="black", bg="#00FFFF", font=('Georgia', 18, 'bold'))
head1.place(x=0, y=0)
